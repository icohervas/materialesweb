...
<html>
    ...
    <body>
        ...
        $conex = new conexion();
        $sqlJUNTAS = "SELECT * FROM JUNTAS";
        

        $sqlJUNTASRESULTSET=$conex->get_consulta($sqlJUNTAS);
    ...
    <div id="contenido_cabecera "style = "display: table; width: 1360px;"> 
            ...
            <div  class="eldiv" style = "float: left; height: 30px; width: 50px;">JUNTAS_ID</div>
...
<?php
if ($sqlJUNTASRESULTSET != 0){
foreach ($sqlJUNTASRESULTSET as $elemento)://repetimos todas las filas de los registros existentes para que se vean en el formulario
  ?>   
   <div  id="contenido_inicial" style = "display: table; width: 1400px;">
   
     <div id ="<?php echo $elemento['JUNTAS_ID'];?>"  class="eldiv" style = "float: left; height: 20px; width: 50px;" oncontextmenu="return showContextMenuInst(event,this.id);"> 
            <?php echo $elemento['JUNTAS_ID'];?>
     </div>
       
    <div   id ="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 60px;" oncontextmenu="return showContextMenuInst(event,this.id);">        
            <?php echo $elemento['FAMILIA'];?>
    </div>
         
    <div  id ="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 100px;" oncontextmenu="return showContextMenuInst(event,this.id);">
            <?php echo $elemento['SUBFAMILIA'];?>
    </div>
       
       <div  id ="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 130px;" oncontextmenu="return showContextMenuInst(event,this.id);">
            <?php echo $elemento['DIAMETRO_MAYOR'];?>
    </div>
     
    <div  id ="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 90px;" oncontextmenu="return showContextMenuInst(event,this.id);">
    ...
    <div  id ="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 100px;"oncontextmenu="return showContextMenuInst(event,this.id);" >
       ...
       <div  id ="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 150px;" oncontextmenu="return showContextMenuInst(event,this.id);">
            <?php echo $elemento['CODIGO_L_CONCATENADO'];?>
    </div> 
       
       <div  id ="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 200px;" oncontextmenu="return showContextMenuInst(event,this.id);">
     ...
     <img id ="<?php echo $elemento['JUNTAS_ID'];?>" class="borrar" src="test.jpg" style="width: 100%; height: 100%;" onclick="eliminar_instrumento(this.id)"/>
     </div>
     <div   style = "float: left; height: 20px; width: 20px;">
         <img id ="<?php echo $elemento['JUNTAS_ID'];?>" class="borrar" src="icono-menu.png" style="width: 100%; height: 100%;" onclick="editar_instrumento(this.id)"/>
     </div> 
   </div>  
