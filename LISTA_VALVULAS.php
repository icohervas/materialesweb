...
<html>
    ...
    <body>
        ...
        $conex = new conexion();
        $sqlVALVULAS = "SELECT * FROM valvulas";
        

        $sqlVALVULASRESULTSET=$conex->get_consulta($sqlVALVULAS);
    ...
    <div id="contenido_cabecera "style = "display: table; width: 1360px;"> 
            ...
            <div  class="eldiv" style = "float: left; height: 30px; width: 50px;">VALVULAS_ID</div>
...
<?php
if ($sqlVALVULASRESULTSET != 0){
foreach ($sqlVALVULASRESULTSET as $elemento)://repetimos todas las filas de los registros existentes para que se vean en el formulario
  ?>   
   <div  id="contenido_inicial" style = "display: table; width: 1400px;">
   
     <div id ="<?php echo $elemento['VALVULAS_ID'];?>"  class="eldiv" style = "float: left; height: 20px; width: 50px;" oncontextmenu="return showContextMenuInst(event,this.id);"> 
            <?php echo $elemento['VALVULAS_ID'];?>
     </div>
       
    <div   id ="<?php echo $elemento['VALVULAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 60px;" oncontextmenu="return showContextMenuInst(event,this.id);">        
            <?php echo $elemento['FAMILIA'];?>
    </div>
         
    <div  id ="<?php echo $elemento['VALVULAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 100px;" oncontextmenu="return showContextMenuInst(event,this.id);">
            <?php echo $elemento['SUBFAMILIA'];?>
    </div>
       
       <div  id ="<?php echo $elemento['VALVULAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 130px;" oncontextmenu="return showContextMenuInst(event,this.id);">
            <?php echo $elemento['DIAMETRO_MAYOR'];?>
    </div>
     
    <div  id ="<?php echo $elemento['VALVULAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 90px;" oncontextmenu="return showContextMenuInst(event,this.id);">
    ...
    <div  id ="<?php echo $elemento['VALVULAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 100px;"oncontextmenu="return showContextMenuInst(event,this.id);" >
       ...
       <div  id ="<?php echo $elemento['VALVULAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 150px;" oncontextmenu="return showContextMenuInst(event,this.id);">
            <?php echo $elemento['CODIGO_L_CONCATENADO'];?>
    </div> 
       
       <div  id ="<?php echo $elemento['VALVULAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 200px;" oncontextmenu="return showContextMenuInst(event,this.id);">
