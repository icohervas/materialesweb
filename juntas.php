...
<html>
    ...
    <body>
        ...
        $sql = "SELECT * FROM JUNTAS WHERE CODIGO_L_CONCATENADO LIKE '%$busqueda%' OR DESCRIPCION LIKE '%$busqueda%'  LIMIT $RegistrosAEmpezar, $RegistrosAMostrar";
...
foreach ($sqlRESULTSET as $elemento)://repetimos todas las filas de los registros existentes para que se vean en el formulario
  ?>   
   <div  id="contenido_inicial" style = "display: table; width: 1250px;">
     ...
     <div id ="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 30px;" oncontextmenu="return showContextMenu(event,this.id);"> 
            <?php echo $elemento['JUNTAS_ID'];?>
     </div>
       
    <div   id ="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 60px;" oncontextmenu="return showContextMenu(event,this.id);">        
            <?php echo $elemento['FAMILIA'];?>
    </div>
         
    <div id="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 300px;" oncontextmenu="return showContextMenu(event,this.id);">
            <?php echo $elemento['SUBFAMILIA'];?>
    </div>
       
       <div  id ="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 100px;" oncontextmenu="return showContextMenu(event,this.id);">
            <?php echo $elemento['DIAMETRO_MAYOR'];?>
    </div>
     
    <div  id ="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 50px;" oncontextmenu="return showContextMenu(event,this.id);">
    ...
    <div  id ="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 50px;"oncontextmenu="return showContextMenu(event,this.id);" >
       ...
       <div  id ="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 70px;"oncontextmenu="return showContextMenu(event,this.id);">
       ...
       <div  id ="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 200px;" oncontextmenu="return showContextMenu(event,this.id);">
            <?php echo $elemento['DESCRIPCION'];?>
    </div> 
       
       <div  id ="<?php echo $elemento['JUNTAS_ID'];?>" class="eldiv" style = "float: left; height: 20px; width: 150px;" oncontextmenu="return showContextMenu(event,this.id);">
            <?php echo $elemento['CODIGO_CARTAGENA'];?>
    </div> 
       
 
     <div   style = "float: left; height: 20px; width: 20px;">
     <img id ="<?php echo $elemento['JUNTAS_ID'];?>" class="borrar" src="test.jpg" style="width: 100%; height: 100%;" onclick="eliminar_valvula(this.id)"/>
     </div>
     <div   style = "float: left; height: 20px; width: 20px;">
         <img id ="<?php echo $elemento['JUNTAS_ID'];?>" class="borrar" src="icono-menu.png" style="width: 100%; height: 100%;" onclick="editar_valvula(this.id)"/>
     </div> 
   </div>  
...
//echo $busqueda;
 ...
 $sqltotalregistros = "SELECT JUNTAS_ID  FROM JUNTAS WHERE CODIGO_L_CONCATENADO LIKE '%$busqueda%'";
